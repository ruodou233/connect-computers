...
- **git 独立 clone**：确认 origin 指向官方仓 https://github.com/ruodou233/connect-computers 后 `git fetch`；仅当本地 HEAD 是 `origin/main` 的祖先（可 fast-forward）时视为有更新。本地领先、分叉或工作树有改动时不提示更新，只提醒使用者本地有未同步改动。
